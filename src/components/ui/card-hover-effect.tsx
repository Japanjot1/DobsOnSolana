...
export const Card = ({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl h-full w-full p-4 overflow-hidden bg-sky-600/90 border border-transparent relative z-20",
        className
      )}
    >
...
export const CardDescription = ({
  ...
  return (
    <p
      className={cn(
        "mt-8 text-white/50 tracking-wide leading-relaxed text-md",
        className
      )}
    >
      {children}
